---
name: fullstack
description: "Starter prompt to build a BFF cookie-session auth stack — TanStack Start frontend, .NET FastEndpoints backend, and Keycloak with a Postgres session store — in a dockerized *.localhost harness."
type: prompt
tags: [fullstack, dotnet, tanstack, keycloak, bff, auth]
