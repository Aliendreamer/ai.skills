...
COPY Directory.Build.props Directory.Packages.props <AppName>.Backend.csproj ./
...
EXPOSE 8080
CMD ["dotnet", "watch", "run", "--project", "<AppName>.Backend.csproj", "--urls", "http://0.0.0.0:8080", "--non-interactive"]
